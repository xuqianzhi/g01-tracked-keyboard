...
public class TextDisplayManagerBehavior : MonoBehaviour
{
    ...
    String[] getSentence(int count)
    {
        string[] words = new string[]
        {
            ...
            "wooden", "rusty", "rascal", "putting", "dismayed", "graced", "injured", "soulful", "bigger", "severed",
            "sat", "base", "hiring", "themed", "moldy", "whimsy", "straw", "bondage", "woes", "crammed", "famous",
            "foolish",
            "surgeon", "replete", "synthesis", "blazing", "action", "powerful", "lopsided", "scared", "torment",
            "turret", "hearing", "woman", "cull", "gone", "maine", "cousins", "surly", "wail", "life", "tears",
            "feature",
            "southern", "taken", "glass", "eerie", "twisting", "rolling", "steamed", "happy", "brandy", "gulf",
            "chafed", "asphalt", "hideous", "thematic", "item", "rogue", "toasted", "control", "mainstay", "years",
            "shadowy",
            ...
            "house", "stabilize", "heels", "author", "fails", "stepped", "drive", "yolks", "perfume", "woman",
            "enslave",
            "itself", "brazen", "silent", "exist", "muffled", "spear", "bereave", "biting", "freeze", "bleeds",
            "handle",
            "pistol", "deeds", "capital", "lateness", "rummage", "flatter", "doubt", "decide", "purge", "deify",
            "gallop",
            ...
            "northern", "hemisphere", "slip", "kindle", "image", "thought", "malady", "liquid", "fortify", "glue",
            "stones",
            "loved", "belong", "thieves", "cross", "season", "greatest", "tennis", "issue", "monarch", "present",
            "dessert", "entice", "poise", "act", "warmly", "suspect", "divided", "guided", "thesaurus", "entrance",
            "hail",
            "using", "candle", "gelato", "aging", "listen", "purpose", "scheme", "thirst", "dainty", "coasting",
            "spurred", "signal", "gravity", "crypto", "deaths", "ending", "state", "poisons", "mammal", "mend",
            "staying",
            ...
            "minty", "fresh", "foot", "drought", "planet", "invisible", "quote", "barely", "killing", "storied",
            "dress",
            ...
            "kissed", "cloud", "velvet", "proof", "canvas", "foot", "subordinate", "beverage", "albeit", "life",
            "raged",
            ...
            "perish", "race", "peaceful", "outing", "maternal", "peering", "knew", "fled", "country", "ranks",
            "sixpence",
            ...
            "siting", "enchant", "equity", "thousand", "thinker", "tall", "fall", "kingly", "burns", "lies", "headbutt",
            "sick",
            ...
            "unfit", "still", "annoy", "counsel", "summers", "often", "waft", "legal", "sparkle", "doing", "map",
            "amaze",
            "amiable", "dance", "thrifty", "govern", "dials", "littlest", "sesame", "red", "expend", "gait", "owner",
            "gather", "seeing", "money", "eldest", "strive", "demand", "where", "buckled", "sterile", "finish",
            "receipt",
            ...
            "park", "fawns", "torment", "enforce", "beaten", "upright", "proper", "heroine", "placement", "born",
            "germans",
            ...
            "access", "indicate", "served", "joint", "rabbits", "closed", "kneel", "guard", "launder", "censure",
            "witty",
            ...
            "honors", "mentor", "removed", "absolved", "wanting", "changed", "endeavor", "author", "assault",
            "withdrawal",
            ...
            "tokeep", "temporary", "leaden", "title", "teach", "youths", "cheap", "happens", "suits", "secrecy",
            "snares",
            "beads", "heat"
        };
